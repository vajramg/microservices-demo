...
public final class EmailServiceGrpc {
   ...
   */
  public static EmailServiceBlockingV2Stub newBlockingV2Stub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<EmailServiceBlockingV2Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<EmailServiceBlockingV2Stub>() {
        @java.lang.Override
        public EmailServiceBlockingV2Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new EmailServiceBlockingV2Stub(channel, callOptions);
        }
      };
    return EmailServiceBlockingV2Stub.newStub(factory, channel);
  }
   ...
   */
  public static final class EmailServiceBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<EmailServiceBlockingV2Stub> {
    private EmailServiceBlockingV2Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected EmailServiceBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new EmailServiceBlockingV2Stub(channel, callOptions);
    }
    ...
    /**
     */
    public hipstershop.Demo.Empty sendOrderConfirmation(hipstershop.Demo.SendOrderConfirmationRequest request) throws io.grpc.StatusException {
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service EmailService.
   */
